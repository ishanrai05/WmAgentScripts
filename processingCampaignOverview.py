...
def getEventsDetails(acquisitionEra, dataTierName, searchStr):
    ...
    for dataset in reply:
        if (acquisitionEra in dataset['dataset'] and (searchStr == 'NA' or (
                searchStr != 'NA' and searchStr in dataset['dataset']))):
...
def main():
    ...
    [events1, events2] = getEventsDetails(
        'Summer12', 'AODSIM', 'LowPU2010_DR42')
    ...
    [events1, events2] = getEventsDetails(
        'HiWinter13', 'GEN-SIM-RECO', 'HiWinter13-STARTHI53')
    print 'HiWinter13DR53X : VALID = ', events1, ' VALID+PROD = ', events2
    [events1, events2] = getEventsDetails(
        'HiWinter13', 'GEN-SIM-RECO', 'HiWinter13-pa_STARTHI53')
